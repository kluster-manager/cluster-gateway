...
require (
	...
	github.com/kluster-manager/cluster-auth v0.4.1
...
replace sigs.k8s.io/apiserver-runtime => github.com/kmodules/apiserver-runtime v1.1.2-0.20260216061920-0c9de491e728
