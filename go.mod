...
require (
	...
	github.com/kluster-manager/cluster-auth v0.4.0
...
replace sigs.k8s.io/apiserver-runtime => github.com/kmodules/apiserver-runtime v1.1.2-0.20250422194347-c5ac4abaf2ae
